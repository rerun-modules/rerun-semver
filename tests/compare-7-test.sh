...
# The Plan
# --------
describe "compare-invalid-rcs-with-equals"

#
# comparison type: equals -- invalid special versions
#

# ------------------------------
# X.X-A != X.X.X
# ------------------------------
it_ret3_when_left_rc_ver_invalid() {
  local exitcode=
...
# X.X.X != X.X-A
# ------------------------------
it_ret3_when_right_rc_ver_invalid() {
  local exitcode=
  $(rerun semver: compare \
